...
[t_Pt_01, x_Pt_01, y_Pt_01,c_Pt_01] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_01,1050); %Choosing 0.1 = N_0 as the starting value, same as Cox '81
[t_Pt_015, x_Pt_015, y_Pt_015,c_Pt_015] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_015,1050);
[t_Pt_02, x_Pt_02, y_Pt_02,c_Pt_02] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_02,1050);
[t_Pt_025, x_Pt_025, y_Pt_025,c_Pt_025] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_025,1050);
[t_Pt_03, x_Pt_03, y_Pt_03,c_Pt_03] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_03,1050);
[t_Pt_035, x_Pt_035, y_Pt_035,c_Pt_035] = polyani_wigner(8,550, Ea_Pt * kcal_to_J,0,10^13,N_035,1050);
...
arrh_y = [log(beta* 0.012/0.09),log(beta* 0.0186/0.09), log(beta*0.0232/0.09),log(beta* 0.0267/0.09), log(beta * 0.0296/0.09), log(beta* 0.03209/0.09)];
...
plot(x_Pt_01 , SB_Ns_01, 'Color', cmap(1,:), 'DisplayName', '0.1 Normalized Converage');
plot(x_Pt_01, s_Pt_01 * (N_01 / SIM_max_new_y_all),'--','Color', cmap(1,:), 'DisplayName','0.1 Normalized Signal');
