...
%Trying out 
[~] = getcoverageplotcoverage_noNORM(time(tempSPAN_actual_0p4), signalSPAN_actual_0p4, N0_0p4,'k');
[N_test] = getcoverageplotcoverage_noNORM(time(tempSPAN_actual_0p8), signalSPAN_actual_0p8, N0_0p8,'k');
[~] = getcoverageplotcoverage_noNORM(time(tempSPAN_actual_1p2), signalSPAN_actual_1p2, N0_1p2,'k');
[~] = getcoverageplotcoverage_noNORM(time(tempSPAN_actual_1p6), signalSPAN_actual_1p6, N0_1p6, 'k');
