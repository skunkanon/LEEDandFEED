...
x_0p8 = x_0p8_raw(51:85); %restricting temperature range 
figure(1);
hold on;
...
bg_pre_raw_12 = y_1p2_raw(1:51); %51 = 1000 K
bg_post_raw_12 = y_1p2_raw(84:95); %85 = 1350 K 
...
bg_12 = @(x) bg_pre_12 + (x-1000)*((bg_post_12-bg_pre_12)/(1340-1000)); %Temps that index 51 and 85 correspond to 

bg_span_12 = linspace(1000,1340,84-51+1); %Number of indices from 51 to 85 

x_1p2 = x_1p2_raw(51:84); %restricting temperature range 
figure(1);
hold on;
