function [t_span,tmp_span,rate_span] = madix_sim(C_0,Eact)
...
y_E = -1.25 * kcal_to_j; %4kcal/mol into j/mol, eq) 14 
Ea = @(C) Ea_0 + C*y_E;
...
%C_0 = 1;
f = 0.9; %3/8 comment, higher values seem to work
